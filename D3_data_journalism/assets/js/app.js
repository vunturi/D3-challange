// @TODO: YOUR CODE HERE!
// D3 Awesome Animated Scatter Plot


// Set the width of the containing box
var width = parseInt(d3.select("#scatter").style("width"));

// Set the height of the graph
var height = width - width / 4;

// Graph margin spacing and space for words
var margin = 20;
var labelArea = 110;

// Bottom and left axes padding for text
var tPadBot = 40;
var tPadLeft = 40;
...
// Set the radius for dots in the graph.
...
// xText will let us to select the group without excess code.
var xText = d3.select(".xText");

// Give xText a transform property that places it at the bottom of the chart
// ir order to easily change the location of the label group whenever the width of the window changes
...
// Using xText to append three text SVG files with y coordinates specified to space out the values
// 1. Poverty
xText
  .append("text")
  .attr("y", -26)
...
// In order to make our transform attributes more readable, we specify the variables like this
...
// ====================================
// Calling a "visualize" function on the data obtained with d3's .csv method
...
function visualize(theData) {
  ...
  // Seting defaults carrying the same names as the headings in their matching .csv file
  var curX = "poverty";
  var curY = "obesity";

  // Save empty variables for our min and max values of x and y
  ...
  var toolTip = d3
    ...
    .html(function(d) {
      ...
      if (curX === "poverty") {
        ...
        // Otherwise, grab the x key and a version of the value formatted to include 
        // commas after every third digit
        theX = "<div>" +
          curX +
          ": " +
  ...
  // This makes it possible to add true mobile-responsiveness to the charts
